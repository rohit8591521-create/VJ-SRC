...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8984296437:AAHNDT6wLxGbldmtn3nOww_TAQyyDtpjf80")
...
ADMINS = int(os.environ.get("ADMINS", "8600526963"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003903422245")
